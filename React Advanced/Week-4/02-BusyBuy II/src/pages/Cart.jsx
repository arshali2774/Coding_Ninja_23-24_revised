...
import { addOrderThunk } from '../features/order/orderThunk';

const Cart = () => {
  const { cart, totalItems, totalAmount, cartsLoading, cartsError } =
                ...
                <HStack h={'full'}>
                  ...
                  >
                    ...
                    <Button
                      colorScheme='red'
                      onClick={() =>
                        dispatch(removeCartItemThunk(c.cartItemId))
                      }
                    >
                      Remove
                    </Button>
          ...
          <HStack mt={'2rem'} px={'20rem'}>
            ...
            <Link to={'/order'}>
              <Button
                colorScheme='pink'
                onClick={() =>
                  dispatch(addOrderThunk({ cart, cartTotal: totalAmount }))
                }
              >
                Purchase
              </Button>
